                      ...
                      <div className="sc-1sjqft3-1 ckHxed">
                        <div className="sc-1sjqft3-2 ckPTIm">
                          ...
                          <div className="sc-14iqfbv-0 bRlYaZ">
                            <div className="sc-14iqfbv-01 bRlYaZZ">
...
{/*                           <span  class="label label-info mr-12"><h5>Chọn loại thẻ</h5> </span>

                            <select name="Chọn loại giấy" id="inputChọn Loại Giấy" class="form-control" required="required">
                            	<option value="">CMND</option>
                            	<option value="">GPLX</option>
